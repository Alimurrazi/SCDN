    <!-- Basic -->
        ...
        <link rel="stylesheet" href="{{ URL::asset('asset/css/owl.carousel.css') }}" type="text/css">
        
        <link rel="stylesheet" href="{{ URL::asset('asset/css/owl.theme.css') }}" type="text/css">
        <link rel="stylesheet" href="{{ URL::asset('asset/css/owl.transitions.css') }}" type="text/css">
        <!-- Css3 Transitions Styles  -->
        <link rel="stylesheet" type="text/css" href="{{ URL::asset('asset/css/animate.css') }}">
        <!-- Lightbox CSS -->
        <link rel="stylesheet" type="text/css" href="{{ URL::asset('asset/css/lightbox.css') }}">
