            ...
            <div class="overlay">
                <div class="container">
                    <div class="intro-text">
                        <h1>SUST CSE Developer's Network <!-- <span>Great Sulfur</span> -->
                        </h1>
                        <h1><span>SCDN</span></h1>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 wow zoomIn" data-wow-duration="2s" data-wow-delay="300ms">
                    <p>We Help !<br> We Built !!<br>We Care !!!</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <!-- End Team Member Section -->
        ...
        <div class="section-title text-center wow fadeInDown" data-wow-duration="2s" data-wow-delay="50ms">
                        ...
                        <a href="#"><i class="fa fa-youtube-play fa-5x" aria-hidden="true" style="color: red"></i></a>
                                                    ...
                                                    <div class="col-md-3">
                        <a href="#"><i class="fa fa-twitter fa-5x" aria-hidden="true" style="color: #00aced"></i></a>
                    </div>
                                                    <div class="col-md-3">
                        <a href="#"><i class="fa fa-github fa-5x" aria-hidden="true" style="color: black"></i></a>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="footer-address">
                            <ul>
                                <li class="footer-contact"><i class="fa fa-home"></i>Dr.M.A. Wazed Miah IICT Building,SUST,Sylhet</li>
                                <li class="footer-contact"><i class="fa fa-envelope"></i><a href="#">SCDN@gmail.com</a></li>
                                <li class="footer-contact"><i class="fa fa-globe"></i><a href="#" target="_blank">www.SCDN.com</a></li>
                            </ul>
                        </div>
                    </div><!--/.col-md-3 -->
